...
echo Launching Mohist-1.12.2-2541029-server.jar with arguments '%*' and '%mem%' max memory

:: add nogui to the end of this line to disable the gui ::
java -Xmx%mem% -XX:MaxPermSize=256M -jar Mohist-1.12.2-2541029-server.jar %*
PAUSE
